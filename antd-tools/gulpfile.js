...
function tag() {
  ...
  execSync(
    `git push https://${process.env.GITHUB_TOKEN}@github.com/yonyougov/gov-design-vue.git ${version}:${version}`,
  );
  execSync(
    `git push https://${process.env.GITHUB_TOKEN}@github.com/yonyougov/gov-design-vue.git master:master`,
  );
  console.log('tagged');
}
